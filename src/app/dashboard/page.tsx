        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <button 
                className="w-full flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200 text-left"
                onClick={() => router.push("/event-form")}
              >
              ...
              <div className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 opacity-60">
